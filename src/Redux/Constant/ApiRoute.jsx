export const API_URL = {
    ...
    BANNERS                    : `${process.env.REACT_APP_BASE_URL}/api/banners`,
    TOP_BOOKED_TEST            : `${process.env.REACT_APP_BASE_URL}/api/topBookedTest`,
    ...
    SEND_OTP                  : `${process.env.REACT_APP_BASE_URL}/api/contact-us/send-otp`,
    VERIFY_OTP                : `${process.env.REACT_APP_BASE_URL}/api/contact-us/verify-otp`,
